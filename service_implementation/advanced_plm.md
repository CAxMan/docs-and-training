...
where the last part (integer value) is a native PLM object identifier.
...
Note that in order to use this functionality, GSS URIs need to be converted into native PLM object identifiers (see above for converter functions).

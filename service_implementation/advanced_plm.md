...
The PLM Server has its own implementation of the GSS services. GSS offers SOAP and REST services:
...
GSS covers a small subset of simplified methods (services) of the PLM Server.

Java (Maven) client based examples can be retrieved from here: https://github.com/CAxMan/PlmGSS-samples

The PLM Server is also accessible via the GSS implementation by SINTEF.
Code samples of that are here: https://github.com/CAxMan/infrastructureClients/tree/master/gssClients
...
Java (Maven) client based examples can be retrieved from here: https://github.com/CAxMan/plm_soap_samples
